...
export default function GalleryPage() {
  ...
  return (
    <>
      ...
      <main className="mx-auto w-full max-w-7xl flex-1 px-2 py-4 sm:px-4">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center gap-2 py-32 text-center">
            <h1 className="text-lg font-semibold">No photos yet</h1>
            <p className="max-w-sm text-sm text-muted-foreground">
              Hit <span className="font-medium text-foreground">Upload</span> to add your
              first photo — faces are detected right in your browser and files land
      ...
      {lightboxIndex !== null && (
        <Lightbox
          photos={photos as LightboxPhoto[]}
          index={lightboxIndex}
